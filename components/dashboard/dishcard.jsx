...
export default function dishcard() {
    ...
    <div className="bg-white border border-gray-200 rounded-lg max-w-full dark:bg-gray-800 dark:border-gray-700">
        ...
        <div className="p-5">
            <a href="#">
                <h5 className="text-slate-700 font-body text-md tracking-tight mb-2 dark:text-white">fish curry</h5>
            </a>
            <a href="#" className="text-white bg-slate-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                Read more
